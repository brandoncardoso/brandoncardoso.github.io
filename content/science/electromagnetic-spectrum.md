...
<figure>
  <img src="/images/electromagnetic-wave.gif" style="max-width:400px"/>
  <figcaption>
    Model of an electromagnetic wave.
    <cite>"EM wave gif" by And1mu, CC BY-SA 4.0</cite>
    </figcaption>
</figure>

* the electric field ($\blue{\vec{E}}$) and magnetic field ($\red{\vec{B}}$) are perpendicular to each other
...
<figure>
  <img src="/images/photon-symbol.svg" class="img-bg-light" style="max-width:200px"/>
  <figcaption>
    <cite>"Photon arrow" by Napy1kenobi, Public domain</cite>
    </figcaption>
</figure>

* a particle of EM radiation is called a **photon**
* all EM radiation travels at the speed of light $(c)$ in a vacuum: $c=3\times10^8\space\pu{m/s}=300{,}000{,}000\space\pu{m/s}$
...
<figure>
  <img src="/images/electromagnetic-spectrum.svg" class="img-bg-light" style="max-width:800px"/>
  <figcaption>
    <cite>"EM spectrum properties" by Inductiveload, CC BY-SA 3.0</cite>
    </figcaption>
</figure>
...
* $1\space\text{hertz}\space(\pu{Hz})$ = 1 cycle/second
* EM frequencies range from $10^4\space\pu{Hz}$ to $10^{20}\space\pu{Hz}$

### Energy

* photon energy increases as frequency increases
* one unit used to measure the energy of an individual photon is the electronvolt $(\pu{eV})$
