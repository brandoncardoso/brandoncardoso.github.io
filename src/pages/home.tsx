			...
			<ul>
				...
				<li>
					<Trans
						...
						components={{
							a: <Link href="https://github.com/brandoncardoso/movie-bot" aria-label={t('projects.moviebot.aria')} />
						}}
					/>
				</li>
				<li>
					<Trans
						...
						components={{
							a: <Link href="https://github.com/brandoncardoso/hima" aria-label={t('projects.hima.aria')} />
						}}
					/>
				</li>
			</ul>
